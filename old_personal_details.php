  	...
  	<div class="col-md-12">
       ...
       ?>
	      ...
	      <div class="card-body">
	      	...
	      	<form id="example-form" method="post" action="tab.php">
                    <div>
	        ...
	        <div class="container mt-3">
						...
						<ul class="nav nav-tabs" id="myTabs">
						    ...
						    <li class="nav-item">
						      <a class="nav-link" data-toggle="tab" href="#menu1">Financial Goal</a>
						    </li>
						    <li class="nav-item">
						...
						<div class="tab-content">
						    <div id="home" class="container tab-pane active"><br>
						      ...
						      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> -->
				                ...
				                <form class="form-sample" method="post">
				                    ...
				                    <button type="button" class="btn btn-primary mb-2" name="save_personal_details">Submit</button>

				                  <!-- <button type="button" class="btn btn-primary mb-2 btnNext" id="prevBtn" >Previous</button> -->
      										<!-- <button type="button" class="btn btn-primary mb-2 btnNext" id="nextBtn" >Next</button> -->
		              			</form>
						    </div>
						    ...
						    <!--   <h3>Menu 1</h3>
						      ...
						      <h4 class="card-title">Horizontal Two column</h4> -->
				                <form class="form-sample" method="post">
				                   ...
				                   <!--  <div class="form-group row">
					                    ...
					                    <div class="col-md-2">
					                          <label for="exampleInputPassword1"><br></label><br>
					                           <button type="button" id="add_financial_goal"  name="addmore" class="btn btn-primary btn-sm" style="float: center;">+</button>
					                    </div>
					                  </div> -->
					               ...
					               <!--  <button type="button" class="btn btn-primary mb-2 btnPrevious" id="prevBtn" >Previous</button>
      										<button type="button" class="btn btn-primary mb-2 btnNext" id="nextBtn" >Next</button> -->
						    ...
						    <div id="menu2" class="container tab-pane fade"><br>
						     ...
						     <!-- <button type="button" class="btn btn-primary mb-2 previous-tab" id="prevBtn" >Previous</button>
      					<button type="button" class="btn btn-primary mb-2 next-tab" id="nextBtn" >Next</button> -->
						</div>
					</div>
